		...
		<div class="container">
			...
			<div class='card'>
				...
				<div class='card-body'>
					...
					<form method="post"
						action="${pageContext.request.contextPath}/utente/list"
						class="row g-3">
						...
						<div class="col-md-6 form-check" id="ruoliDivId">
							<p>Ruoli:</p>
							<c:forEach items="${ruoli_totali_attr}" var="ruolo">
								<div class="form-check">
									<input type="checkbox" id="${ruolo.id}" name="ruoli"
										value="${ruolo.id}" class="form-check-input" /> <label
										for="${ruolo.id}" class="form-check-label">${ruolo.codice}</label>
								</div>
							</c:forEach>
						</div>
						...
						<div class="col-12">
							...
							<input class="btn btn-outline-warning" type="reset"
								...
								href="${pageContext.request.contextPath}/utente/insert">Add
								New</a>
						</div>
