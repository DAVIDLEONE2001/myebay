...
<body class="d-flex flex-column h-100">
			                	...
			                	<c:forEach items="${utente_list_attribute }" var="utenteItem">
									<tr>
										...
										<td>
											...
											<a id="changePassLink_#_${utenteItem.id }" class="btn  btn-sm btn btn-danger ml-2 mr-2 btn-sm link-for-modal" data-bs-toggle="modal" data-bs-target="#confirmOperationModal2">Reset password</a>
										</td>
									</tr>
								</c:forEach>
			                </tbody>
	...
	<!-- Modal -->
	<div class="modal fade" id="confirmOperationModal2" tabindex="-1"  aria-labelledby="confirmOperationModalLabel"
	    aria-hidden="true">
	    <div class="modal-dialog" >
	        <div class="modal-content">
	            <div class="modal-header">
	            ...
	            <form method="post" action="${pageContext.request.contextPath}/utente/editPassword" >
		            <div class="modal-footer">
		            	<input type="hidden" name="idUtenteForChanginPass" id="idUtenteForChanginPass">
		                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Chiudi</button>
		                <input type="submit" value="Continua"  class="btn btn-primary">
		            </div>
	            </form>
	...
	<script type="text/javascript">
		...
		$(".link-for-modal").click(function(){
			...
			$('#idUtenteForChanginPass').val(callerId);
