	...
	<main class="flex-shrink-0">
		<div class="container">
			...
			<div class="p-5 mb-4 bg-light rounded-3">
				<div class="container-fluid py-5">
					<h1 class="display-5 fw-bold">Sei Niente</h1>
					...
					<a class="btn btn-primary btn-lg"
						href="${pageContext.request.contextPath}/regista/search">Vai a
						Ricerca</a>
				</div>
			</div>
		...
		<div class="container px-4 py-5" id="featured-3">
			<div class="row g-4 py-5 row-cols-1 row-cols-lg-3">
				...
				<div class="col-lg-4">
  <div class="rounded-circle overflow-hidden d-flex justify-content-center align-items-center" style="width: 140px; height: 140px; background-color: var(--bs-secondary-color);">
    <img src="C:\Users\David\OneDrive\Immagini\SFONDI\wp4892358-minimal-4k-pc-wallpapers.jpg" alt="Image" class="w-100 h-100 object-fit-cover">
  </div>
