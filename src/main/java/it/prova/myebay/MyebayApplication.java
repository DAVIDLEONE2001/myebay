...
public class MyebayApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		if (categoriaService.cercaPerDescrizione("Casalinghi") == null) {
			
			Categoria categoriaCasalinghi = new Categoria("Casalinghi", "CASALINGHI");
			categoriaService.inserisciNuovo(categoriaCasalinghi);
			
		}
		if (categoriaService.cercaPerDescrizione("Motori") == null) {
			
			Categoria categoriaMotori = new Categoria("Motori", "MOTORI");
			categoriaService.inserisciNuovo(categoriaMotori);
			
		}
		if (categoriaService.cercaPerDescrizione("Elettronica") == null) {
			
			Categoria categoriaElettronica = new Categoria("Elettronica", "ELETTRONICA");
			categoriaService.inserisciNuovo(categoriaElettronica);
			
		}
		if (categoriaService.cercaPerDescrizione("Sport") == null) {
			
			Categoria categoriaSport = new Categoria("Sport", "SPORT");
			categoriaService.inserisciNuovo(categoriaSport);
